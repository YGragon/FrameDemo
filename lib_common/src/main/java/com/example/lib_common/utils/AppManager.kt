...
class AppManager {
    ...
    fun addActivity(activity: AppCompatActivity) {
        ...
        LogUtils.d("AppManager---->>", "add---->>$activity size---->>${activityStack.size}")
    }
    ...
    fun removeActivity(activity: AppCompatActivity) {
        if (activityStack.contains(activity)) {
            ...
            LogUtils.d("AppManager---->>", "remove---->>$activity size---->>${activityStack.size}")
        }
    }
    ...
    fun finishAllActivity() {
        ...
        activityStack.clear()
        LogUtils.d("AppManager---->>", "Finish All Activity!")
    }
    ...
    fun appExit() {
        try {
            ...
            LogUtils.d("AppManager---->>", "Application Exit!")
        }
    }
}