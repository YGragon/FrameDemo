...
public abstract interface ApiService {
    ...
    public abstract io.reactivex.rxjava3.core.Observable<com.example.lib_common.http.response.BaseResponse<okhttp3.ResponseBody>> regionCollect(@retrofit2.http.Path(value = "id")
    int id);
    ...
    public abstract io.reactivex.rxjava3.core.Observable<com.example.lib_common.http.response.BaseResponse<okhttp3.ResponseBody>> regionUnCollect(@retrofit2.http.Path(value = "id")
    int id);
    ...
    int status, @retrofit2.http.Query(value = "orderby")
    int orderby);
