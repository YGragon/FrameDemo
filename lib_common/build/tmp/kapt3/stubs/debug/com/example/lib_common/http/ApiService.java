...
public abstract interface ApiService {
    ...
    public abstract io.reactivex.Observable<com.example.lib_common.http.BaseResponse<java.util.List<com.example.lib_common.model.SearchList>>> getSearchs(@retrofit2.http.Path(value = "page")
