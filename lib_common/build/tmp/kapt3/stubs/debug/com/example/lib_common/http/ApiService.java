...
public abstract interface ApiService {
    ...
    public abstract io.reactivex.rxjava3.core.Observable<com.example.lib_common.http.response.BaseResponse<com.example.lib_common.model.CollectBean>> regionCollect(@retrofit2.http.Path(value = "id")
    int id);
    ...
    public abstract io.reactivex.rxjava3.core.Observable<com.example.lib_common.http.response.BaseResponse<com.example.lib_common.model.CollectBean>> regionUnCollect(@retrofit2.http.Path(value = "id")
    int id);
